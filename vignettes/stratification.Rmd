...
strat_quantiles(
  ...
  map = TRUE) # combine stratifications to a mapped output
```
...
strat_breaks(mraster = mraster$pzabove2, # single raster
...
```{r}
#--- map srasters ---#
strat_map(sraster = srasters, # two layer sraster
          plot = TRUE)
...
```{r}
strat_map(sraster = srasters, # strat_poly 3 class stratification
