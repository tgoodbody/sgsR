...
*   `calculate_*` - The calculate verb implies that functions are performing calculations to be used in consequent processing. The use of predefined sample analysis algorithms `calculate_representation()`, `calculate_coobs()` are also included.
