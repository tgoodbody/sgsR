...
raster <- "C:/Users/goodb/Documents/UBC/post_doc/sgsR/inst/extdata/rmf_metrics.tif" #system.file("extdata","rmf_metrics.tif", package = "sgsR")
...
existing <- extract_existing(sraster = raster,
                             existing = srs_wo)
