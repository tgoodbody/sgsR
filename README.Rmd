...
If you _aren’t_ working with ALS data, any remote sensing data sets in a raster format (e.g. optical satellite imagery, climate data, drone-based products) can be used as inputs to help guide your environmental sampling needs.
...
urls <- c("https://www.researchgate.net/profile/Martin-Queinnec/",
          ...
          "https://www.fs.usda.gov/rmrs/people/ahudak/",
